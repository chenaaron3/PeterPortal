    ...
    return (
      <div className="App" style={{ display: "flex", flexDirection: "column" }}>
        <div className="legal_page">
          ...
          <p>
            PeterPortal uses your personally identifiable information (such as
            email) purely for authentication purposes of logged-in users. We
            monitor some site analytics that collect anonymous, aggregated data
            that is not personally identifiable. This activity data is useful
            for us as we consider how we can help PeterPortal evolve to meet
            your needs.
          </p>
          <h2>Information Disclosure</h2>
          <p>
            We do not disclose any personally identifiable information to any
            entity. We also do not disclose any anonymous data to any external
            entities. The sole purpose of anonymous, aggregated data collection
            is for internal analysis within our organization.
          </p>
          <h2>External links</h2>
          <p>
            Any links provided on this site to content outside of our domain is
            not protected by this privacy policy, and we cannot guarantee any
            level of protection for doing so. We advise everyone to exercise
            their own discretion when interacting with content leading to
            external sources.
          </p>
          <h2>Cookie Policy</h2>
          <p>
            We use cookies to store your username, email, and phone number so
            that PeterPortal remembers you when you log in again. This allows us
            to give you an individual experience on this site and increase your
            accessibility.
          </p>
          <h2>Changing Policy</h2>
          <p>
            As PeterPortal grows and evolves, so may our privacy policy. We will
            announce these changes publicly as we deem them necessary so you can
            always make informed choices regarding your personal information
            here.{" "}
          </p>
          <h2>Contact</h2>
          <p>
            If you have any further questions regarding these policies or
            anything else, contact{" "}
            <a href="mailto:peterportal.dev@gmail.com">
              peterportal.dev@gmail.com
            </a>
            .
          </p>
          <Divider />
          {/* <h1>📜 Terms and Conditions</h1>
          <p>Last updated: May 31, 2020</p>
          <p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to PeterPortal.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to PeterPortal, accessible from{" "}
                <a
                  href="peter-portal.com"
          ...
          <ul>
            <li>By email: peterportal.dev@gmail.com</li>
          </ul> */}
        </div>
      </div>
    );
